...
export default {
    ...
    setup(_,{emit}) {
        ...
        console.log(_.bot_base,'=============')
        alldone_.value = _.bot_base;
        console.log('!!!!',alldone_,alldone_.value)
        onMounted(()=>{
        ...
        bot_div1.addEventListener("mouseenter",function(){
            ...
            console.log('+++++++',_.bot_base,'&&&&&&&&&&&',typeof _.bot_base,typeof alldone_.value)
           kwang_done_c.value =  alldone_.value  + 500;
            console.log(alldone_,alldone_.value,'{{{{{{{{{{{{{{{{{{',kwang_done_c.value)            
        });
        ...
        const full_c1 = ()=>{
            ...
            emit("botton_index","1x Fullness","full_index_2.value")
        };
        const full_c2 = ()=>{
            full_index_2.value = full_index_1.value +200;
            console.log(full_index_2.value);
            emit("botton_index","1.5x Fullness")
        };
        const full_c3 = ()=>{
            full_index_2.value = full_index_1.value +300;
            console.log(full_index_2.value);
            emit("botton_index","2x Fullness")
        }
        ...
        return {full_index,full_c1,full_c2,full_c3,full_index_1,full_index_2,small_img,kwang_done_c,alldone_}
