    ...
    <!-- 步骤调转 -->
      <section class="kwang_step_a" style="position: relative;">
        <ul class="kwang_step_ul">
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 1 == index}"><span @click="index = 1" :class="{active_fc : 1 == index}"> 1</span></div>
               <div class="k_step_d" :class="{active_fc : 1 == index}">Style</div>
               <p ref="root_1"></p>
           </li>
           <li class="k_step_li">
               <div class="k_step_u" :class="{k_step_active : 2 == index}"><span @click="index = 2" :class="{active_fc : 2 == index}"> 2</span></div>
               <div class="k_step_d" :class="{active_fc : 2 == index}">Rod Installed</div>
               <p ref="root_2"></p>
           </li>
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 3 == index}"><span @click="index = 3" :class="{active_fc : 3 == index}"> 3</span></div>
               <div class="k_step_d" :class="{active_fc : 3 == index}">Coverage Width</div>
               <p ref="root_3"></p>
           </li>
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 4 == index}"><span @click="index = 4" :class="{active_fc : 4 == index}"> 4</span></div>
               <div class="k_step_d" :class="{active_fc : 4 == index}">Coverage Length</div>
               <p ref="root_4"></p>
           </li>
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 5 == index}"><span @click="index = 5" :class="{active_fc : 5 == index}"> 5</span></div>
               <div class="k_step_d" :class="{active_fc : 5 == index}">Panels</div>
               <p ref="root_5"></p>
           </li>
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 6 == index}"><span @click="index = 6" :class="{active_fc : 6 == index}"> 6</span></div>
               <div class="k_step_d" :class="{active_fc : 6 == index}">Fullness</div>
               <p></p>
           </li>
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 7 == index}"><span @click="index = 7" :class="{active_fc : 7 == index}"> 7</span></div>
               <div class="k_step_d" :class="{active_fc : 7 == index}">Botton</div>
               <p></p>
           </li>
           <li class="k_step_li" >
               <div class="k_step_u" :class="{k_step_active : 8 == index}"><span @click="index = 8" :class="{active_fc : 8 == index}"> 8</span></div>
               <div class="k_step_d" :class="{active_fc : 8 == index}">All done </div>
               <p></p>
           </li>
        </ul>
      </section>
...
export default {
  ...
  setup(props) {
    ...
    return {index,myBack,style_index,root_1,rod_index,root_2,width_index,root_3,length_index,root_4,panel_index,root_5,noRod};
  }
}
